      ...
      <li class="nav-item">
        ...
        <div id="collapseMenu" class="collapse" aria-labelledby="headingMenu" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Menu Area:</h6>
...
<!-- Guests Menu -->
<li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseGuests" aria-expanded="true" aria-controls="collapseTwo">
                ...
                <div id="collapseGuests" class="collapse" aria-labelledby="headingGuests" data-parent="#accordionSidebar">
                  <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Guests Component:</h6>
                  <a class="collapse-item" href="{{url('/guest')}}">Manage Guests</a>
                  </div>
                </div>
              </li>
      ...
      <!-- Rooms Area -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseRooms" aria-expanded="true" aria-controls="collapseUtilities">
        ...
        <div id="collapseRooms" class="collapse" aria-labelledby="headingRooms" data-parent="#accordionSidebar">
          ...
          <a class="collapse-item" href="{{url('/room')}}">Manage Rooms</a>
          </div>
        </div>
      </li>
      ...
      <!-- Our Menu -->
<li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseServices" aria-expanded="true" aria-controls="collapsePages">
        ...
        <div id="collapseServices" class="collapse" aria-labelledby="headingServices" data-parent="#accordionSidebar">
          ...
          <a class="collapse-item" href="{{url('/service')}}">Add Services</a>
          </div>
        </div>
      </li>
            ...
            <div class="input-group">
                <div class="card">
                    <div class="card-body bg-secondary text-white">
                        <h5>MAGAWA HOTEL RESERVATION SYSTEM</h5>
                    </div>
                </div>
            </div>
          </form>
        ...
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <p>Copyright &copy; <script>document.write(new Date().getFullYear());</script>| 
                ...
                Magawa Hotel</a> | All rights reserved.</p>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
